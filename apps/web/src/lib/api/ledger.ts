/**
 * API client for the ledger bounded context.
...
export async function createLedger(data: unknown) {
  return apiPost(`${PREFIX}`, data);
}

export async function updateLedger(id: string, data: unknown) {
